...
function addCartClicked(event)
{
  ...
  var productId=product.getElementsByClassName('product-id')[0].innerText;
...
function addProductToCart(id,name,price,image)
{
  ...
  <div class="cart-box row">
      ...
      <div class="col-md-8">
        <div class="product-cart-id" style="display:none">${id}</div>
...
function postCart()
{
  ...
  for(var i=0;i<cartItems.length;i++)
  {
      ...
      var priceElement = cartBox.getElementsByClassName('cart-price')[0];
      var quantityElement = cartBox.getElementsByClassName('cart-quantity')[0];
      var productId= cartBox.getElementsByClassName('product-cart-id')[0].innerText;
      var quantity= quantityElement.value;
      var price = parseFloat(priceElement.innerText.replace("$",""));
